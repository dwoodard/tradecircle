...
<html>
	...
	<body style="padding:30px;">
		...
		<div class="wizard" id="meida-cloud-setup">
			<h1>Install Trade Circle</h1>
			<div class="wizard-card" data-onValidated="setServerName" data-cardname="name">
				<h3>Welcome to Trade Circle</h3>
				<div class="wizard-input-section">
					<p>
						Welcome to Trade Circle this wizard will guide you through the installation and configuration.
					</p>
					...
					<div class="control-group">
						...
						<div class="row">
							...
							<div class="span1">
								...
								<input style="width:125px;" type="text" name="database" placeholder="media" value="tradecircle" />
							</div>
						</div>
						<div class="row">
							<div class="span3">
